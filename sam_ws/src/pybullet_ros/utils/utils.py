...
def extract_point_clouds(depth, K, segmap=None, rgb=None, z_range=[0.0,1.8], segmap_id=0, skip_border_objects=False, margin_px=5):
        """
...
def create_point_cloud_and_camera(rgb, depth, mask, K, camera_transform=np.eye(4), color=None):
    ...
    # pc_full, pc_segments, pc_colors = extract_point_clouds(depth=depth, K=K, segmap=mask, rgb=rgb)
